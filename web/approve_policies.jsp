       ...
       public void fetch()
        {
            try
            {
                ...
                stmt=conn.prepareStatement("select A.policy_no,A.cust_id,type,purchase_date,premium_amt,frequency,policy_start_date,policy_exp_date,next_premium_date,approved,life_cover,premium_paying_term,nominee_id,C.name,C.city from policy A,life_insurance B,cust C where A.approved='NO' and C.cust_id=A.cust_id and A.policy_no=B.policy_no ");             
                ...
                while(rs.next())
                {
                    ...
                    vlife_cover.add(rs.getString("life_cover"));
                    vpremium_paying_term.add(rs.getString("premium_paying_term"));
...
<script type="text/javascript" src="Template/jquery.poptrox-1.0.js"></script>
        <title>Approve Life Insurance Policies</title>
    </head>
     <div id="wrapper">
			...
			<div class="entry">
				<ul>
					...
					<li>
						<h3>Quick Links</h3>
						<ul>
							<li> <a href="approved_policies.jsp">Click here </a>to view approved policies</li>
    ...
    <body>
        ...
        <h2 align="center">Generated Life Insurance Policies</h2>
        <h3 align="center">Select policies to change approval status to YES</h3>
       
      
            <form action="approve_policies.jsp" method="POST" >
         <br>
                ...
                <tbody>
                    <tr>
                       ...
                       <td><input type="checkbox" name="ckb" value="<%=vpolicy_no.get(i)%>"/></td>
                        ...
                        <td><%=vlife_cover.get(i)%></td>
                        <td><%=vpremium_paying_term.get(i)%></td>
                         <td><%=vnominee_id.get(i)%></td>
