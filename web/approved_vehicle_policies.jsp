<%-- 
    Document   : approved_vehicle_policies
    Created on : May 6, 2013, 4:35:47 PM
    Author     : Sac
--%>
       ...
       public void fetch()
        {
            try
            {
                ...
                stmt=conn.prepareStatement("select A.policy_no,A.cust_id,type,purchase_date,premium_amt,frequency,policy_start_date,policy_exp_date,next_premium_date,approved,B.reg_no,B.engine_no,B.purchase_value,B.make,C.name,C.city from policy A,vehicle_insurance B,cust C where A.approved='YES' and C.cust_id=A.cust_id and A.policy_no=B.policy_no ");             
...
<script type="text/javascript" src="Template/jquery.poptrox-1.0.js"></script>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Approved Vehicle Insurance Policies</title>
    </head>
     <div id="wrapper">
			...
			<div class="entry">
				<ul>
					...
					<li>
						<h3>Quick Links</h3>
						<ul>
							<li> <a href="approve_vehicle_policies.jsp">Click here </a>to approve policies</li>
    ...
    <body>
        ...
        <h1 align="center">Approved Vehicle Insurance Policies</h1>
        <h3 align="center">Select policies to change approval status to NO</h3>
        <body bgcolor="grey">
      
            <form action="approved_vehicle_policies.jsp" method="POST" >
         <br>
          <%
                ...
                <tbody>
                    <tr>
                       ...
                       <td><input type="checkbox" name="ckb" value="<%=vpolicy_no.get(i)%>"/></td>
                        ...
                        <td><%=vmake.get(i)%></td>
                        <td><%=vreg_no.get(i)%></td>   
                        <td><%=vengine_no.get(i)%></td>
                        <td><%=vpurchase_value.get(i)%></td> 
                     </tr>
                     <% 
                            } 
                     %>                    
