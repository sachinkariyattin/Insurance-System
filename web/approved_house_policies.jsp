       ...
       public void fetch()
        {
            try
            {
                ...
                stmt=conn.prepareStatement("select A.policy_no,count(D.policy_no) as members,A.cust_id,type,purchase_date,premium_amt,frequency,policy_start_date,policy_exp_date,next_premium_date,approved,buildingcost,electricalcost,jewelery,C.name,C.city from policy A,house_insurance B,cust C,house_members D where A.approved='YES' and C.cust_id=A.cust_id and A.policy_no=B.policy_no and B.policy_no=D.policy_no group by A.policy_no,A.cust_id,type,purchase_date,premium_amt,frequency,policy_start_date,policy_exp_date,next_premium_date,approved,buildingcost,electricalcost,jewelery,C.name,C.city ");             
...
<script type="text/javascript" src="Template/jquery.poptrox-1.0.js"></script>
        <title>Approve House Policies</title>
    </head>
    <div id="wrapper">
			...
			<div class="entry">
				<ul>
					...
					<li>
						<h3>Quick Links</h3>
						<ul>
							<li> <a href="approve_house_policies.jsp">Click here </a>to approve generated House Insurance policies</li>
    ...
    <body>
        ...
        <h1 align="center">Approved House Insurance Policies</h1>
        <h3 align="center">Select policies to change approval status to NO</h3>
        <body bgcolor="grey">
      
            <form action="approved_house_policies.jsp" method="POST" >
         <br>
          <%
