<%-- 
    Document   : generated_loan_details
    Created on : May 23, 2013, 6:06:02 PM
    Author     : Sac
--%>
...
<%!
  ...
  <%
           ...
           var_loan_no=obj.getAttribute("session_loan_no").toString(); 
...
<script type="text/javascript" src="Template/jquery.poptrox-1.0.js"></script>
    ...
    <form action="generated_loan_details.jsp" method="POST" >
    <body>
