<%-- 
    Document   : approve_vehicle_policies
    Created on : May 6, 2013, 4:19:28 PM
    Author     : Sac
--%>
...
<script type="text/javascript" src="Template/jquery.poptrox-1.0.js"></script>
        <title>Approve Vehicle Insurance Policies</title>
    </head>
     <div id="wrapper">
			...
			<div class="entry">
				<ul>
					...
					<li>
						<h3>Quick Links</h3>
						<ul>
							<li> <a href="approved_vehicle_policies.jsp">Click here </a>to view approved policies</li>
    ...
    <body>
       ...
       <h2 align="center">Generated Vehicle Insurance Policies</h2>
        <h3 align="center">Select policies to change approval status to YES</h3>
       
        <body bgcolor="grey">
      
            <form action="approve_vehicle_policies.jsp" method="POST" >
         <br>
