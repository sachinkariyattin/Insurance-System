<%-- 
    Document   : home
    Created on : Apr 12, 2013, 4:45:04 PM
    Author     : Sac
--%>
	...
	<div id="menu-wrapper">
		<ul id="menu">
			...
			<li> <span>   login  </span>
			  ...
			  <ul>
                              <li class="first"><a href="logincust.jsp"> Customer Login</a></li>
			...
			<div class="contentbg">
				<div id="slider">
					<div class="viewer">
						<div class="reel">
							<div id="gallery">
                                                            <div class="slide"> <a href="images/health.jpg"><img src="Template/images/health.jpg" width="590" height="300" alt="" /></a> </div>
                                                            <div class="slide"> <a href="images/house.jpg"><img src="Template/images/house.jpg" width="590" height="300" alt="" /></a> </div>
                                                            <div class="slide"> <a href="images/life-insurance1_1.jpg"><img src="Template/images/life-insurance1_1.jpg" width="590" height="300" alt="" /></a> </div>
                                
								<div class="slide"> <a href="images/vehicle.jpg"><img src="Template/images/vehicle.jpg" width="590" height="300" alt="" /></a> </div>
							</div>
						</div>
					</div>
				</div>
  ...
  &quot;Home sweet home  be it ever so humble&quot; is true for everyone. Home is one of your biggest  investments. Get this biggest investment protected with ISTM Householders'  Package Policy which is tailor made to insure your individual home and prized  possessions.<br />
		...
		<div id="sidebar-bg">
			<div id="sidebar">
				<ul>
					<li>
						<h3>Welcome to ISTM</h3>
						<p>Our company provides Health Insurance,Life Insurance,House Insurance and Motor Insurance policies</p>
					</li>
					<li>
						<h3>Quick Links</h3>
						<ul>
...
<div id="footer">
	<p>2013. ISTM.com. All rights reserved. Design by <a href="http://www.TECH_CRUNCHERS.org/">&copy Tech Crunchers</a>.</p>
</div>
<!-- end #footer -->
</body>
</html>
