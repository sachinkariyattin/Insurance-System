<%-- 
    Document   : view_vehicle_insurance
    Created on : May 10, 2013, 5:43:40 PM
    Author     : Sac
--%>
...
<%!
     ...
     String purchase_date,start_date,email,policy_no,reg_no,engine_no,purchase_value,make="";
...
<%
    ...
    var_policy_no=obj.getAttribute("session_policy_no").toString();    //Session variable created in motor_insurance.jsp
...
<script type="text/javascript" src="Template/jquery.poptrox-1.0.js"></script>
    ...
    <form action="view_vehicle_insurance.jsp" method="POST" >
        <div id="wrapper">
