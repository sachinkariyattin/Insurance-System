d<%-- 
    Document   : approve_health_policies
    Created on : May 6, 2013, 3:47:16 PM
    Author     : Sac
--%>
...
<script type="text/javascript" src="Template/jquery.poptrox-1.0.js"></script>
			...
			<div class="entry">
				<ul>
					...
					<li>
						<h3>Quick Links</h3>
						<ul>
							<li><a href="approved_health_policies.jsp">Click here </a>to view approved policies</li>
    ...
    <body>
          ...
          <h2 align="center">Generated Health Insurance Policies</h2>
        <h3 align="center">Select policies to change approval status to YES</h3>
       
      
            <form action="approve_health_policies.jsp" method="POST" >
         <br>
          <%
