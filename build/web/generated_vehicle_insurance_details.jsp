<%-- 
    Document   : generated_vehicle_insurance_details
...
<%!
     ...
     String purchase_date,next_premium_date,start_date,expiry_date,email,policy_no,reg_no,engine_no,purchase_value,make="";
     String var_policy_no;
       ...
       public void fetch()
       {
           try
            {
                stmt=conn.prepareStatement("select A.cust_id,A.name,A.dob,A.email_id,B.policy_no,B.frequency,B.premium_amt,B.policy_start_date,B.policy_exp_date,B.next_premium_date,C.reg_no,C.engine_no ,C.purchase_value,C.make from cust A,policy B,vehicle_insurance C where B.policy_no=? and B.cust_id=A.cust_id and B.policy_no=C.policy_no");             
               ...
               purchase_value=rs.getString("purchase_value");
...
<%
    ...
    var_policy_no=obj.getAttribute("session_vehicle_policy_no").toString();    //Session variable created in motor_insurance.jsp
...
<script type="text/javascript" src="Template/jquery.poptrox-1.0.js"></script>
        <title>Vehicle Insurance Policy Details</title>
    </head>
    <div id="wrapper">
    ...
    <form action="generated_vehicle_insurance_details.jsp" method="POST" >
    <body>
        <br>
