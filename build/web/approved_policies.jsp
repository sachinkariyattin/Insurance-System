       ...
       public void fetch()
        {
            try
            {
                ...
                stmt=conn.prepareStatement("select A.policy_no,A.cust_id,type,purchase_date,premium_amt,frequency,policy_start_date,policy_exp_date,next_premium_date,approved,life_cover,premium_paying_term,nominee_id,name,city from policy A,life_insurance B,cust C where A.approved='YES' and C.cust_id=A.cust_id and A.policy_no=B.policy_no ");             
...
<script type="text/javascript" src="Template/jquery.poptrox-1.0.js"></script>
        <title>Approved Life Insurance Policies</title>
    </head>
     <div id="wrapper">
 ...
 <li><a href="about.jsp" target="_blank"><span>About</span></a></li>
			...
			<div class="entry">
				<ul>
					...
					<li>
						<h3>Quick Links</h3>
						<ul>
							<li> <a href="approve_policies.jsp">Click here </a>to approve policies</li>
    ...
    <body>
         ...
         <h1 align="center">Approved Life Insurance Policies</h1>
        <h3 align="center">Select policies to change approval status to NO</h3>
        
        
        <body bgcolor="grey">
      
            <form action="approved_policies.jsp" method="POST" >
         <br>
          <%
