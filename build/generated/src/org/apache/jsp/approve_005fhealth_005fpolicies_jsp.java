...
public final class approve_005fhealth_005fpolicies_jsp extends org.apache.jasper.runtime.HttpJspBase
       ...
       public void fetch()
        {
            try
            {
                ...
                stmt=conn.prepareStatement("select A.policy_no,A.cust_id,type,purchase_date,premium_amt,frequency,policy_start_date,policy_exp_date,next_premium_date,approved,B.sum_insured,name,city from policy A,health_insurance B,cust C where A.approved='NO' and C.cust_id=A.cust_id and A.policy_no=B.policy_no ");             
   ...
   if(request.getParameter("btnsubmit")!=null)
     {
      ...
      out.write("        <title>Approve Health Insurance Policies</title>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        <a href=\"approved_health_policies.jsp\">Click here </a>to view approved policies\n");
      out.write("        \n");
      out.write("          <h2 align=\"center\">Generated Health Insurance Policies</h2>\n");
      out.write("        <h3 align=\"center\">Select policies to change approval status to YES</h3>\n");
      out.write("        <body bgcolor=\"grey\">\n");
      out.write("      \n");
      out.write("            <form action=\"approve_health_policies.jsp\" method=\"POST\" >\n");
      out.write("         <br>\n");
      out.write("          ");
      ...
      out.write("        </form>\n");
      out.write("         \n");
      out.write("         <a href=\"select_policy_type.jsp\">Click here </a>to choose a different policy type\n");
      out.write("    </body>\n");
      out.write("</html>\n");
    } catch (Throwable t) {
